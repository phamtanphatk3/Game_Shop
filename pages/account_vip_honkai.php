...
$sql = "SELECT * FROM accounts WHERE type='VIP' AND game_type='honkai'";
...
<head>
    ...
    <title>Tài Khoản VIP Honkai: Star Rail</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản VIP Honkai: Star Rail 🎮</h1>
