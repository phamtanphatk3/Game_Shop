...
$sql = "SELECT * FROM accounts WHERE type='VIP' AND game_type='www'";
...
<head>
    ...
    <title>Tài Khoản VIP Wuthering Waves</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản VIP Wuthering Waves 🎮</h1>
