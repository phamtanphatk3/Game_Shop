...
$sql = "SELECT * FROM accounts WHERE type='REROLL' AND game_type='genshin'";
...
<head>
    ...
    <title>Danh sách tài khoản Reroll</title>
...
<body>
    <div class="container mt-5">
        <h2 class="text-warning text-center">🎲 Danh Sách Tài Khoản Reroll 🎲</h2>
        <div class="row mt-4">
