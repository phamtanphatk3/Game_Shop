...
$sql = "SELECT * FROM accounts WHERE type='RANDOM' AND game_type='www'";
...
<head>
    ...
    <title>Tài Khoản Random Wuthering Waves</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Random Wuthering Waves 🎮</h1>
