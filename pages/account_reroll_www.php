...
$sql = "SELECT * FROM accounts WHERE type='REROLL' AND game_type='www'";
...
<head>
    ...
    <title>Tài Khoản Reroll Wuthering Waves</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Reroll Wuthering Waves 🎮</h1>
