...
$sql = "SELECT * FROM accounts WHERE type='STARTER' AND game_type='zzz'";
...
<head>
    ...
    <title>Tài Khoản Starter Zenless Zone Zero</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Starter Zenless Zone Zero 🎮</h1>
