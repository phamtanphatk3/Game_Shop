...
$sql = "SELECT * FROM accounts WHERE type='REROLL' AND game_type='zzz'";
...
<head>
    ...
    <title>Tài Khoản Reroll Zenless Zone Zero</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Reroll Zenless Zone Zero 🎮</h1>
