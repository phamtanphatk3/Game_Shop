...
$sql = "SELECT * FROM accounts WHERE type='REROLL' AND game_type='honkai'";
...
<head>
    ...
    <title>Tài Khoản Reroll Honkai: Star Rail</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Reroll Honkai: Star Rail 🎮</h1>
