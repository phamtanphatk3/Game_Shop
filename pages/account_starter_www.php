...
$sql = "SELECT * FROM accounts WHERE type='STARTER' AND game_type='www'";
...
<head>
    ...
    <title>Tài Khoản Starter Wuthering Waves</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Starter Wuthering Waves 🎮</h1>
