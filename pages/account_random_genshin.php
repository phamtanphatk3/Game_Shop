...
$sql = "SELECT * FROM accounts WHERE type='RANDOM' AND game_type='genshin'";
...
<head>
    ...
    <title>Danh sách tài khoản Random</title>
...
<body>
    <div class="container mt-5">
        <h2 class="text-warning text-center">🎯 Danh Sách Tài Khoản Random 🎯</h2>
        <div class="row mt-4">
