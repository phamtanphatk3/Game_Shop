...
$sql = "SELECT * FROM accounts WHERE type='VIP' AND game_type='zzz'";
...
<head>
    ...
    <title>Tài Khoản VIP Zenless Zone Zero</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản VIP Zenless Zone Zero 🎮</h1>
