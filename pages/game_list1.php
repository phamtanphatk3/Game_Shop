...
<head>
    ...
    <title>Shop Acc Genshin Impact</title>
...
<body>
    ...
    <div class="container text-center mt-5">
        <h2>🎮 GENSHIN IMPACT ACCOUNTS 🎮</h2>
        <p class="text-light mb-5">Chất lượng cao - Giao dịch an toàn - Giá tốt nhất</p>

        <div class="row mt-4">
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="../images/genshin.jpg" class="card-img-top" alt="VIP Account">
                    <div class="card-body text-center">
                        <h5>Account VIP</h5>
                        <p>Số lượng: 120</p>
                        <a href="account_vip_genshin.php" class="btn btn-custom w-100">🔹 Xem Ngay</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="../images/genshin.jpg" class="card-img-top" alt="Starter Account">
                    <div class="card-body text-center">
                        <h5>Account Starter</h5>
                        <p>Số lượng: 342</p>
                        <a href="account_starter_genshin.php" class="btn btn-custom w-100">🔹 Xem Ngay</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="../images/genshin.jpg" class="card-img-top" alt="Reroll Account">
                    <div class="card-body text-center">
                        <h5>Account Reroll</h5>
                        <p>Số lượng: 587</p>
                        <a href="account_reroll_genshin.php" class="btn btn-custom w-100">🔹 Xem Ngay</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <img src="../images/genshin.jpg" class="card-img-top" alt="Random Account">
                    <div class="card-body text-center">
                        <h5>Account Random</h5>
                        <p>Số lượng: 215</p>
                        <a href="account_random_genshin.php" class="btn btn-custom w-100">🔹 Xem Ngay</a>
                    </div>
                </div>
            </div>
        </div>
