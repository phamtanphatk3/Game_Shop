...
$sql = "SELECT * FROM accounts WHERE type='VIP' AND game_type='genshin'";
...
<head>
    ...
    <title>Tài Khoản VIP Genshin Impact</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản VIP Genshin Impact 🎮</h1>
