...
$sql = "SELECT * FROM accounts WHERE type='RANDOM' AND game_type='honkai'";
...
<head>
    ...
    <title>Tài Khoản Random Honkai: Star Rail</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Random Honkai: Star Rail 🎮</h1>
