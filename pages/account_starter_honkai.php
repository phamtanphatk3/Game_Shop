...
$sql = "SELECT * FROM accounts WHERE type='STARTER' AND game_type='honkai'";
...
<head>
    ...
    <title>Tài Khoản Starter Honkai: Star Rail</title>
...
<body>
    <div class="container">
        <h1 class="page-title">🎮 Tài Khoản Starter Honkai: Star Rail 🎮</h1>
